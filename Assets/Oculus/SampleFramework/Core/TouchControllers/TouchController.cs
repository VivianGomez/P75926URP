...
namespace OVRTouchSample
{
    ...
    public class TouchController : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            if(!cameraRotationActive && OVRInput.Get(OVRInput.Axis2D.PrimaryThumbstick, m_controller).x!=0)
            {
                GameObject.Find("MOBController").GetComponent<MOBController>().VerifyUserAction(new MOBObject.Action(gameObject.name, "TouchedThumbstick",""));
            }
        }
